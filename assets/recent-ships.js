  ...
  function vsHtml(s) {
    try {
      if (window.trustedTypes && window.trustedTypes.createPolicy) {
        window.__vsRecentShipsPolicy = window.__vsRecentShipsPolicy ||
          window.trustedTypes.createPolicy('vs-recent-ships', { createHTML: function (h) { return h; } });
        return window.__vsRecentShipsPolicy.createHTML(s);
      }
    } catch (_e) {}
    return s;
  }
