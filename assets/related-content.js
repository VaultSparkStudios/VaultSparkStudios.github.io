  ...
  function vsHtml(s) {
    try {
      if (window.trustedTypes && window.trustedTypes.createPolicy) {
        window.__vsRelatedContentPolicy = window.__vsRelatedContentPolicy ||
          window.trustedTypes.createPolicy('vs-related-content', { createHTML: function (h) { return h; } });
        return window.__vsRelatedContentPolicy.createHTML(s);
      }
    } catch (_e) {}
    return s;
  }
