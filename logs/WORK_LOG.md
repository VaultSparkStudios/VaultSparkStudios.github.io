...
**Honest limits:** `api/identity-migration-receipt.json` is **still the 2026-08-26 copy** — my rebuild of it timed out and I did not retry; the ceremony regenerates it anyway. The 14-day probe clock has no automated re-probe cadence yet, so it will go stale on its own and fall honestly back to `missing`; boarded. Obelisk is **not** complete: the provider journey remains unobserved.
