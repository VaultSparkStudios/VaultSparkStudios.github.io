...
- Rebasing incorporated the latest hourly main commits before final proof. Full suite **244/244 EXIT 0**; Doctor **13/15**, two warnings, `blockingFailing: 0`; staged secret scan clean. Exact committed candidate `7d2f6019f` deployed to Hetzner staging (4,270 files / 92.4 MiB, rollback `20260727095749`) plus staging-only Worker `e79918e1-24e4-47ba-9651-f7968be1f6c1`; standalone candidate parity EXIT 0 and exact-candidate Chromium/Firefox/WebKit release matrix **6/6**. Production was not promoted.
