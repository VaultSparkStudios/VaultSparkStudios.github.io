...
- Isolated the unrelated pre-existing worktree mismatch from the release candidate, then passed the canonical 295-step build from step one (receipt `bb1ee419581096a7e6c89f29`; plan `d808a9610d8b1a4e18defbb4`; source `88410c01a3f370cca28463e9`).
