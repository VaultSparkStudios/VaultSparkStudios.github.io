...
- **Staging:** exact committed candidate `7d2f6019f` deployed atomically to Hetzner (4,270 files / 92.4 MiB; rollback `20260727095749`) and the staging Worker only was updated to version `e79918e1-24e4-47ba-9651-f7968be1f6c1`. Candidate SHA + 24-leaf Merkle root match; standalone parity exits 0; exact-candidate Chromium/Firefox/WebKit release replay is 6/6.
