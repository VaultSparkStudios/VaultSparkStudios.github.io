...
- Post-push verification truth changed in Session 88: E2E and Accessibility now pass in GitHub Actions against the local preview artifact; Lighthouse is the only red gate, failing on real thresholds rather than Cloudflare challenge HTML (homepage performance `0.55`, homepage SEO `0.93`, `/games/` performance `0.84`).
