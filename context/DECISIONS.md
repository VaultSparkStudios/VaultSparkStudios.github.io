...
### 2026-06-25 — S221 (arc) — P0 CI root-fix (gitignored lockfile vs `npm ci`); gated the class; orphan-rot exposed a self-counting bug; canon-freshness caught a header lie; agents.json coherence; Forge-Window re-rejected
