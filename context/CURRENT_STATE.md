...
- Current phase: Session 30 complete (2026-04-02) — Gridiron GM status updated to Vaulted/Not Available sitewide (index.html, gridiron-gm/index.html, roadmap/index.html, games/index.html); games catalog filter script rewritten as robust IIFE with DOMContentLoaded guard, null checks, and type="button" on all filter buttons; Vaulted filter tab added to games catalog; hero stats corrected (1 Live / 1 Beta / 1 Vaulted / 4 In Development); commit 0bec70d pushed to main
