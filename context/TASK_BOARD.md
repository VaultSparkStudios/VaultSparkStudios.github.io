...
Last updated: 2026-08-10 (Session 309 shipped the Director's Report live with a bespoke share card, and built `resync-derived` — the derived-graph repairer the repo had a checker for but no cure)
