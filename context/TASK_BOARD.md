...
Last updated: 2026-08-16 (Session 317 restored The Desk's reader loop end to end — Worker deployed so reactions/presence answer live, provenance stopped laundering missing routes as challenges, story labels became reader-facing and correctly derived, per-article reach/read-time/attention/away-time shipped server-rendered, reader-signal rollup added with a monotonic reset guard, and five previously-uncalled gates were wired into build:check: 295 → 302)
