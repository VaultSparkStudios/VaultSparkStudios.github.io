...
(function() {
  ...
  var honestyNote = document.getElementById('pricing-honesty-note');

  window.VSSCheckoutAvailability = {
    annualEnabled: !!(ANNUAL_PLAN_KEYS.sparked && ANNUAL_PLAN_KEYS.pro),
    annualPlanKeys: ANNUAL_PLAN_KEYS
  };
