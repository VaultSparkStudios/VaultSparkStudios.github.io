(function () {
  ...
  // S123: prove-first homepage. Personalization mutates DOM only on deeper pages.
  // The bare `/` is identical for everyone — no profiling, no trust-level shaping.
  ...
  var STAGE_COPY = {
    ...
    exploring:   { eyebrow: 'Welcome back',          cta: 'Open Studio Pulse',     href: '/studio-pulse/' }
  };
