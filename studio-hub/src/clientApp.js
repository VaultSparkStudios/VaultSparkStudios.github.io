...
import { renderFeedbackView, loadFeedbackData } from "./components/feedbackView.js";
...
function renderActiveView() {
  ...
  if (activeView === "feedback")        return renderFeedbackView(state);
...
window.addEventListener("popstate", (e) => {
  ...
  if (view === "feedback" && !state.feedbackData && !state.feedbackLoading) loadFeedbackData(state, render);
});
...
function buildEventCtx() {
  return {
    ...
    loadTickets, submitProjectTicket, submitRenameTicket, submitInitiateTicket, submitSparkTicket, dispatchAnnounceWorkflow,
