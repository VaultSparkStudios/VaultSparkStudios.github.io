...
const FINGERPRINTED_SHELL_ASSETS = [
  ...
  '/assets/faq-toggle.shell-6abbb39184.js',
  '/assets/github-stream.shell-37d24392f4.js',
  '/assets/honest-traction-scoreboard.shell-6b434171f8.js',
  '/assets/ignis-lens.shell-d369cfd082.js',
  '/assets/ignis-project-block.shell-0fbab844d7.js',
  '/assets/oracle-extra.shell-a71c845b99.js',
  '/assets/oracle-insights-compute.shell-355aaa84cf.js',
  '/assets/proof-card.shell-1af2012142.js',
  '/assets/pwa-nav.shell-5f63b6b75a.js',
...
const NON_CACHEABLE_SHELL_SOURCES = [
  ...
  '/assets/faq-toggle.js',
  '/assets/github-stream.js',
  '/assets/honest-traction-scoreboard.js',
  '/assets/ignis-lens.js',
  '/assets/ignis-project-block.js',
  '/assets/oracle-extra.js',
  '/assets/oracle-insights-compute.js',
  '/assets/proof-card.js',
  '/assets/pwa-nav.js',
  '/assets/rate-page.js',
  '/assets/schema-injector.js',
