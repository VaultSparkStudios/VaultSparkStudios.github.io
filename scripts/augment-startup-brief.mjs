#!/usr/bin/env node
/**
 * augment-startup-brief.mjs — thin delegation shim (S172 protocol-script-self-heal)
 *
 * LAST SESSION + SKILL HEALTH brief blocks (R-H5/12/15 S118).
...
const SIBLING = path.resolve(ROOT, '..', 'vaultspark-studio-ops', 'scripts', 'augment-startup-brief.mjs');

if (!existsSync(SIBLING)) {
  console.log('augment-startup-brief.mjs (shim): studio-ops sibling not reachable — skipping.');
  process.exit(0);
}
