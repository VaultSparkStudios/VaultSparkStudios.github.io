...
function buildPage(p) {
  ...
  return `<!DOCTYPE html><html lang="en" class="dark-mode" data-theme="dark"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>${escapeHtml(p.pageTitle)}</title><meta name="description" content="${escapeHtml(p.metaDescription)}"><meta property="og:image" content="${escapeHtml(ogImage)}"><meta property="og:image:alt" content="${escapeHtml(p.pageTitle)}" /><meta name="twitter:image" content="${escapeHtml(ogImage)}"><meta property="twitter:image:alt" content="${escapeHtml(p.pageTitle)}" /><link rel="canonical" href="${escapeHtml('https://vaultsparkstudios.com/pathways/' + p.slug + '/')}"><link rel="stylesheet" href="${depthPrefix}${SAMPLE_STYLE}">${speculationBlock}
