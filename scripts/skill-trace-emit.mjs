#!/usr/bin/env node
/**
 * skill-trace-emit.mjs — thin delegation shim (S172 protocol-script-self-heal)
 *
 * skill telemetry start/step/finish (R-H4 S118).
...
const SIBLING = path.resolve(ROOT, '..', 'vaultspark-studio-ops', 'scripts', 'skill-trace-emit.mjs');

if (!existsSync(SIBLING)) {
  console.log('skill-trace-emit.mjs (shim): studio-ops sibling not reachable — skipping.');
  process.exit(0);
}
