...
export const COMMANDS = {
  ...
  'rescore': {
    ...
    desc: 'IGNIS staleness report and re-score trigger',
    args: '[--project <slug>] [--stale] [--all] [--json]',
    category: 'Session',
  },
  'preload': {
  ...
  'check-sibling-locks': {
    script: 'check-sibling-locks.mjs',
    desc: 'Report stale sibling repo session locks before cross-repo work',
    args: '[--json] [--check] [--threshold-hours N]',
    category: 'Security',
  },
  'sanitize-settings': {
