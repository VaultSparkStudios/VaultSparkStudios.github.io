...
export function buildNewsFeed(days = loadPublicDays()) {
  ...
  return {
    ...
    _vaultspark_engagement: {
      aggregate_feed: `${SITE}/api/news-desk-engagement.json`,
      live_presence_endpoint: `${SITE}/v/desk-presence?slug={date}/{slug}`,
      metric: 'visible-and-focused-seconds',
      privacy_floor: 5,
      exact_live_count_floor: 3,
      caveat: 'Engagement observations are not unique people or Cloudflare visits.',
    },
