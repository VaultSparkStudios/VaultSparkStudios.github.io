#!/usr/bin/env node
/**
 * sync-agent-skills.mjs - thin delegation shim (S246)
 *
...
const SIBLING = path.resolve(ROOT, '..', 'vaultspark-studio-ops', 'scripts', 'sync-agent-skills.mjs');

if (!existsSync(SIBLING)) {
  console.log('sync-agent-skills.mjs (shim): studio-ops sibling not reachable - skipping.');
  process.exit(0);
}
