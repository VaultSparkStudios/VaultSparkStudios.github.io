#!/usr/bin/env node
/**
 * credential-watch.mjs — thin delegation shim (S172 protocol-script-self-heal)
 *
 * MISSING→READY credential transition watcher (S121 G9).
...
const SIBLING = path.resolve(ROOT, '..', 'vaultspark-studio-ops', 'scripts', 'credential-watch.mjs');

if (!existsSync(SIBLING)) {
  console.log('credential-watch.mjs (shim): studio-ops sibling not reachable — skipping.');
  process.exit(0);
}
