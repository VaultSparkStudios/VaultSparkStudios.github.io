...
const REQUIRED_BLOCKS = [
  ...
  {
    // Founder-attention block — renderer emits either "FOUNDER UNLOCKS" or
    // "HUMAN PRESSURE" depending on which code path fires (S115 dual-name
    // canonical alias; both name the same content).
    label: 'HUMAN PRESSURE / FOUNDER UNLOCKS block',
    pattern: /╔══\s*(HUMAN PRESSURE|FOUNDER UNLOCKS)/,
    severity: 'recommended',
  },
];
