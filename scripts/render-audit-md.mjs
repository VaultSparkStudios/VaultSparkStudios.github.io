#!/usr/bin/env node
/**
 * render-audit-md.mjs — thin delegation shim (S172 protocol-script-self-heal)
 *
 * audit md reverse-renderer from JSON sidecar (R-H14 S118) — /audit step 9.
...
const SIBLING = path.resolve(ROOT, '..', 'vaultspark-studio-ops', 'scripts', ...'render-audit-md.mjs'.split('/'));

if (!existsSync(SIBLING)) {
  console.log('render-audit-md.mjs (shim): studio-ops sibling not reachable — skipping.');
  process.exit(0);
}
