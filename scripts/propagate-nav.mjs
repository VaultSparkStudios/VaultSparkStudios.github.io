  ...
  return `<header class="site-header">
    <div class="container nav">
      ...
      <nav class="nav-center" id="nav-menu" aria-label="Primary navigation">
        ...
        <div class="nav-item has-dropdown"><a href="/studio/"${activeAttr(activeHref === '/studio/')}>Studio <span class="caret" aria-hidden="true">&#9660;</span></a><div class="nav-dropdown"><span class="dropdown-label" style="color:#FFC400;">Live Intelligence</span><a href="/nervous-system/" style="color:#FFC400;font-weight:600;">Studio Nervous System</a><a href="/oracle/" style="color:#FFC400;font-weight:600;">⚡ Ecosystem Oracle</a><a href="/studio-pulse/">Studio Pulse</a><a href="/ignis/">IGNIS</a><div class="dropdown-divider"></div><span class="dropdown-label">Studio</span><a href="/studio/">About</a><a href="/roadmap/">Vault Pipeline</a><a href="/changelog/">Changelog</a><a href="/journal/">Signal Log</a><a href="/journal/dispatches/">Insider Dispatches</a><div class="dropdown-divider"></div><span class="dropdown-label">Outside-In</span><a href="/press/">Press Kit</a><a href="/brand/">Brand Kit</a><a href="/social/">Social Channels</a></div></div>
  ...
  return `<footer class="site-footer" aria-label="Site footer">
    <div class="container">
      ...
      <div class="vault-status-legend" style="display:flex;gap:1.5rem;flex-wrap:wrap;align-items:center;padding:1rem 0;margin-top:1rem;border-top:1px solid rgba(255,255,255,0.06);font-size:0.75rem;font-weight:600;letter-spacing:0.04em;">
        ...
        <span style="margin-left:auto;color:var(--muted);font-weight:500;">27 initiatives under the vault banner · <a href="/studio-pulse/" style="color:var(--gold);">open Studio Pulse &rarr;</a></span>
      </div>
