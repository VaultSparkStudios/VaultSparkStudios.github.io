#!/usr/bin/env node
/**
 * session-floor.mjs - thin delegation shim (S246)
 *
...
const SIBLING = path.resolve(ROOT, '..', 'vaultspark-studio-ops', 'scripts', 'session-floor.mjs');

if (!existsSync(SIBLING)) {
  console.log('session-floor.mjs (shim): studio-ops sibling not reachable - skipping.');
  process.exit(0);
}
