...
const SKIP_PATH = [
  ...
  // News pages carry article-specific OG cards generated by build-news-desk;
  // they have og:title now for social sharing but should never receive a
  // generic studio card from this script — skip them entirely.
  'news/',
];
