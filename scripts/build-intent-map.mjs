...
const DEFINITIONS = [
  ...
  { id: 'verify', label: 'Verify studio claims', aliases: ['verify', 'proof', 'evidence', 'status'], audience: ['agent', 'press', 'investor'], primary: '/proof/', fallback: '/status/', action: 'evidence.ledger.verify', evidence: ['api/deploy-currency.json', 'api/worker-route-provenance.json'], maxAgeHours: 24 },
