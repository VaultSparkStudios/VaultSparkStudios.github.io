...
function normalizeAsyncStylesheet(html) {
  return html.replace(
    ...
    (_match, indent, preloadHref, stylesheetHref) => toAsyncStylesheetBlock(indent, preloadHref || stylesheetHref)
  );
}
