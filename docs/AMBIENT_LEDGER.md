...
| `assets/scroll-depth.js` | core | split-candidate | 4.2kb | session gated | low |
...
| `assets/ambient-loader.js` | core | split-candidate | 12.1kb | query-param gated, viewport gated, session gated | medium |
