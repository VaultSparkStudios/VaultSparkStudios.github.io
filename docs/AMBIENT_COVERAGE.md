...
- Sources: **17**  ·  Total: **60.1 KB** (raw)
- Guarded (conditional): **14** modules · **51.6 KB** — split candidates
...
|---|--:|:-:|---|
| `ambient-loader.js` | 7.6 KB | 🔶 guarded | query-param gated, viewport gated, session gated |
