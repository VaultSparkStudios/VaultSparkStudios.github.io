...
- Sources: **17**  ·  Total: **70.2 KB** (raw)
- Guarded (conditional): **13** modules · **57.5 KB** — split candidates
...
|---|--:|:-:|---|
| `ambient-loader.js` | 17.7 KB | 🔶 guarded | query-param gated, viewport gated, session gated |
