...
- Sources: **17**  ·  Total: **67.6 KB** (raw)
- Guarded (conditional): **13** modules · **55.0 KB** — split candidates
...
|---|--:|:-:|---|
| `ambient-loader.js` | 15.2 KB | 🔶 guarded | query-param gated, viewport gated, session gated |
