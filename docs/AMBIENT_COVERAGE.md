...
- Sources: **17**  ·  Total: **62.5 KB** (raw)
- Guarded (conditional): **14** modules · **54.0 KB** — split candidates
...
|---|--:|:-:|---|
| `ambient-loader.js` | 10.0 KB | 🔶 guarded | query-param gated, viewport gated, session gated |
