...
- Sources: **17**  ·  Total: **76.2 KB** (raw)
- Guarded (conditional): **14** modules · **65.7 KB** — split candidates
...
|---|--:|:-:|---|
| `ambient-loader.js` | 20.5 KB | 🔶 guarded | element-presence gated, session gated |
