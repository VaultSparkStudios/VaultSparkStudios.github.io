...
- Sources: **17**  ·  Total: **60.5 KB** (raw)
- Guarded (conditional): **14** modules · **52.0 KB** — split candidates
...
|---|--:|:-:|---|
| `ambient-loader.js` | 8.0 KB | 🔶 guarded | query-param gated, viewport gated, session gated |
