...
- Sources: **17**  ·  Total: **68.2 KB** (raw)
- Guarded (conditional): **13** modules · **55.6 KB** — split candidates
...
|---|--:|:-:|---|
| `ambient-loader.js` | 15.8 KB | 🔶 guarded | query-param gated, viewport gated, session gated |
