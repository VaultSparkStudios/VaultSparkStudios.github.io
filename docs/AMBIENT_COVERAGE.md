...
- Sources: **17**  ·  Total: **69.2 KB** (raw)
- Guarded (conditional): **13** modules · **56.6 KB** — split candidates
...
|---|--:|:-:|---|
| `ambient-loader.js` | 16.8 KB | 🔶 guarded | query-param gated, viewport gated, session gated |
