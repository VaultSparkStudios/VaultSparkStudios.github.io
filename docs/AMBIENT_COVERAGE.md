...
- Sources: **17**  ·  Total: **67.1 KB** (raw)
- Guarded (conditional): **13** modules · **54.4 KB** — split candidates
...
|---|--:|:-:|---|
| `ambient-loader.js` | 14.6 KB | 🔶 guarded | query-param gated, viewport gated, session gated |
