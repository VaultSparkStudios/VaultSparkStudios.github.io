...
- Sources: **17**  ·  Total: **62.0 KB** (raw)
- Guarded (conditional): **14** modules · **53.5 KB** — split candidates
...
|---|--:|:-:|---|
| `ambient-loader.js` | 9.5 KB | 🔶 guarded | query-param gated, viewport gated, session gated |
