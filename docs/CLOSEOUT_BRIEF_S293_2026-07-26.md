...
║                                                                                               ║
║  HEADLINE                                                                                     ║
║    The production edge incident stopped being a level and became a duration — 13.3 days,      ║
║    evidence-bounded, and published where visitors can see it.                                 ║
║                                                                                               ║
...
╚═════════════════════════════════════════════════════════════════════════════════════════════╝
  ...
  [#1]  route-incident-duration                                   PROJ 10  ·  ECOS 9
         ...
         → build-worker-route-history self-test 24/24 · live probe 0/5 · data/worker-route-history.ndjson
