...
> 140 sampled report(s) over last 30 day(s) · clustered by sourceFile:line.
> Parse-blind rows predate the S174 intake fix and age out with the KV TTL.

| Cluster | Count | Days seen | Sink/sample evidence |
|---|---:|---|---|
| `https://vaultsparkstudios.com/journal/dispatches/:364` | 29 | 2026-06-04 | `https://vaultsparkstudios.com/trusted-types-sink` |
...
| `https://vaultsparkstudios.com/assets/home-idle-loader.js:16` | 10 | 2026-06-04, 2026-06-09 | `https://vaultsparkstudios.com/trusted-types-sink` |
| `https://vaultsparkstudios.com/vaultspark-football-gm/lib/appCore.js:1146` | 9 | 2026-06-05 | `Element innerHTML|<button class="link-btn" data-player-id=` |
| `https://vaultsparkstudios.com/assets/schema-injector.js:23` | 8 | 2026-06-04, 2026-06-07, 2026-06-09, 2026-06-10 | `https://vaultsparkstudios.com/trusted-types-sink` |
| `PARSE-BLIND (pre-fix intake rows — no fields survived normalization)` | 5 | 2026-06-03, 2026-06-04, 2026-06-05 | — |
| `https://vaultsparkstudios.com/assets/ambient.shell-3667694cc0.js:337` | 4 | 2026-06-09, 2026-06-10 | `Element innerHTML|<a href="/">Home</a> <span class="vs-bre` |
| `https://vaultsparkstudios.com/assets/ambient.shell-3667694cc0.js:367` | 4 | 2026-06-09, 2026-06-10 | `HTMLScriptElement textContent|{"@context":"https://schema.org","@type"` |
...
| `https://vaultsparkstudios.com/assets/theme-toggle.shell-b970c26bd9.js:394` | 2 | 2026-06-04, 2026-06-06 | `https://vaultsparkstudios.com/trusted-types-sink` |
...
| `https://vaultsparkstudios.com/assets/vault-pulse.js:131` | 2 | 2026-06-04, 2026-06-10 | `https://vaultsparkstudios.com/trusted-types-sink` |
...
| `https://vaultsparkstudios.com/vaultspark-football-gm/lib/tabSettings.js:63` | 2 | 2026-06-05 | `Element innerHTML|<button data-trade-pick-side="B" data-tr` |
...
| `https://vaultsparkstudios.com/assets/ambient.shell-3667694cc0.js:1130` | 1 | 2026-06-05 | `Element innerHTML|<span class="vs-rank-orb-num">+</span><s` |
...
| `https://vaultsparkstudios.com/assets/vault-cta.js:39` | 1 | 2026-06-06 | `Element innerHTML|<div style="flex:1;min-width:160px;"><di` |
