...
#### 5. [VERIFY] Manual CANON-053 rendered-pixel review of the surfaces that only NOW …
Final score: **80**
...
#### 8. [VERIFY] Re-run the Trusted Types KV soak, then decide the enforce flip on cur…
Final score: **74**
