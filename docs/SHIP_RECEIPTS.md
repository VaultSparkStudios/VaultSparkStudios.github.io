...
|---|---:|---|---|
| Transparency | 6 | 4f019bb4 closeout status board<br>a6e945a9 changelog 75-day public-gap close + freshness blockDays gate + RUM beacon honesty<br>dc32ed51 LQIP P0 + INP telemetry + CWV composite + oracle domain rank + changelog draft + push quiz CTA + CI automation<br>3711f5e2 IGNIS oracle:context_boost RUM + build artifact refresh<br>48e6102e IGNIS deploy-hash invalidation + session-context boost + community topics + leaderboard AI discovery | pending |
