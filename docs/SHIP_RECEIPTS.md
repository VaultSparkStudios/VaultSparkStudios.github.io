...
| Transparency | 4 | 48e6102e IGNIS deploy-hash invalidation + session-context boost + community topics + leaderboard AI discovery<br>131f31a6 LCP render-delay root-cause (decoding=async) + heartbeat drift clear<br>8502f758 S224 SIL rolling-status update — 976→983 velocity 7<br>4732f661 S223 SIL rolling-status update — 974→976 velocity 10 | pending |
