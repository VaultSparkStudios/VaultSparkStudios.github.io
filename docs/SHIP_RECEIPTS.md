...
| Transparency | 5 | d6f47a07 IGNIS deploy-hash invalidation + session-context boost + community topics + leaderboard AI discovery<br>9543dd5e LCP render-delay root-cause (decoding=async) + heartbeat drift clear<br>8502f758 S224 SIL rolling-status update — 976→983 velocity 7<br>4732f661 S223 SIL rolling-status update — 974→976 velocity 10<br>fd7adbe1 closeout status board | pending |
